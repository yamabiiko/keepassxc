                           ...
                           const QString& url)
{
    ...
    m_customIconModel->setIcons(database->metadata()->customIconsInOrder(IconSize::Default),
...
bool EditWidgetIcons::addCustomIcon(const QImage& icon)
{
    ...
    if (m_db) {
        ...
        if (uuid.isNull()) {
            ...
            m_customIconModel->setIcons(m_db->metadata()->customIconsInOrder(IconSize::Default),
